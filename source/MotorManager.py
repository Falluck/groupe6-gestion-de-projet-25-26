...
class MotorManager:
    ...
    def setSpeed(self, speed: float) -> None:
        ...
        Raises:
            ValueError: Si speed n'est pas un nombre.
        """
        try:
    ...
    def setAngle(self, steering: float) -> None:
        ...
        Raises:
            ValueError: Si steering n'est pas un nombre.
        """
        try:
    ...
    def convert_steering_to_duty(self, steering: float) -> int:
        ...
        periode_ms = 1000.0 / freq
        t_min_duty = min_pulse_ms / periode_ms
        t_max_duty = max_pulse_ms / periode_ms
